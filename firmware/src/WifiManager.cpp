...
// Forward declaration of external battery monitor
...
void WifiManager::setupAccessPoint()
{
  ...
  server.on("/command", HTTP_POST, [](AsyncWebServerRequest *request) {}, [](AsyncWebServerRequest *request, String filename, size_t index, uint8_t *data, size_t len, bool final) {}, [this](AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total)
